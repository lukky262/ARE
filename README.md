...
- If you downloaded a `.zip` file, right-click it and choose "Extract All." Pick a folder where you want ARE to live.
- If you downloaded an `.exe` file, double-click it to start the installer.

### Step 4: Run ARE Application
